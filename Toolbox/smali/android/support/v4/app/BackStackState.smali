...
.method public constructor <init>(Landroid/support/v4/app/e;)V
    ...
    :cond_1
    iget v1, p1, Landroid/support/v4/app/e;->e:I
    ...
    iget-object v0, v5, Landroid/support/v4/app/i;->d:Landroid/support/v4/app/o;
    ...
    :cond_6
    iget v0, p1, Landroid/support/v4/app/e;->j:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->b:I

    iget v0, p1, Landroid/support/v4/app/e;->k:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iget-object v0, p1, Landroid/support/v4/app/e;->n:Ljava/lang/String;
    ...
    iget v0, p1, Landroid/support/v4/app/e;->q:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iget-object v0, p1, Landroid/support/v4/app/e;->r:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iget v0, p1, Landroid/support/v4/app/e;->s:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    iget-object v0, p1, Landroid/support/v4/app/e;->t:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iget-object v0, p1, Landroid/support/v4/app/e;->u:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iget-object v0, p1, Landroid/support/v4/app/e;->v:Ljava/util/ArrayList;
...
# virtual methods
.method public a(Landroid/support/v4/app/aa;)Landroid/support/v4/app/e;
    .locals 11
    ...
    invoke-direct {v6, p1}, Landroid/support/v4/app/e;-><init>(Landroid/support/v4/app/aa;)V
    ...
    iget-object v4, p1, Landroid/support/v4/app/aa;->f:Ljava/util/ArrayList;
    ...
    iput-object v0, v7, Landroid/support/v4/app/i;->d:Landroid/support/v4/app/o;
    ...
    :cond_1
    iget-object v0, p1, Landroid/support/v4/app/aa;->f:Ljava/util/ArrayList;
