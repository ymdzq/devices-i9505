...
.method constructor <init>(Landroid/view/View;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;Landroid/view/View;)V
    ...
    iput-object p3, p0, Landroid/support/v4/app/ap;->c:Ljava/util/ArrayList;

    iput-object p4, p0, Landroid/support/v4/app/ap;->d:Landroid/transition/Transition;

    iput-object p5, p0, Landroid/support/v4/app/ap;->e:Ljava/util/ArrayList;

    iput-object p6, p0, Landroid/support/v4/app/ap;->f:Landroid/transition/Transition;

    iput-object p7, p0, Landroid/support/v4/app/ap;->g:Ljava/util/ArrayList;

    iput-object p8, p0, Landroid/support/v4/app/ap;->h:Ljava/util/Map;

    iput-object p9, p0, Landroid/support/v4/app/ap;->i:Ljava/util/ArrayList;

    iput-object p10, p0, Landroid/support/v4/app/ap;->j:Landroid/transition/Transition;

    iput-object p11, p0, Landroid/support/v4/app/ap;->k:Landroid/view/View;
...
.method public onPreDraw()Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/ap;->c:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Landroid/support/v4/app/al;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/ap;->d:Landroid/transition/Transition;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v4/app/ap;->d:Landroid/transition/Transition;

    iget-object v1, p0, Landroid/support/v4/app/ap;->e:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Landroid/support/v4/app/al;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/ap;->f:Landroid/transition/Transition;
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/ap;->h:Ljava/util/Map;
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/ap;->i:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroid/support/v4/app/ap;->j:Landroid/transition/Transition;
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/app/ap;->j:Landroid/transition/Transition;

    iget-object v1, p0, Landroid/support/v4/app/ap;->k:Landroid/view/View;
