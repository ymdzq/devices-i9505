...
.field private final e:Landroid/support/v4/widget/t;
...
.field private final k:Landroid/support/v4/widget/bg;

.field private final l:Landroid/support/v4/widget/bg;

.field private final m:Landroid/support/v4/widget/aa;

.field private final n:Landroid/support/v4/widget/aa;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/u;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/t;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/support/v4/widget/t;
    ...
    new-instance v2, Landroid/support/v4/widget/aa;

    const/4 v3, 0x3

    invoke-direct {v2, p0, v3}, Landroid/support/v4/widget/aa;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/aa;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/aa;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/aa;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/bg;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bj;)Landroid/support/v4/widget/bg;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bg;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bg;

    invoke-virtual {v2, v4}, Landroid/support/v4/widget/bg;->a(I)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bg;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/bg;->a(F)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/aa;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bg;

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/aa;->a(Landroid/support/v4/widget/bg;)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/aa;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/bg;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bj;)Landroid/support/v4/widget/bg;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bg;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bg;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/support/v4/widget/bg;->a(I)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bg;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/bg;->a(F)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/aa;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bg;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/aa;->a(Landroid/support/v4/widget/bg;)V

    invoke-virtual {p0, v4}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    invoke-static {p0, v4}, Landroid/support/v4/g/bp;->b(Landroid/view/View;I)V

    new-instance v1, Landroid/support/v4/widget/s;

    invoke-direct {v1, p0}, Landroid/support/v4/widget/s;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Landroid/support/v4/g/bp;->a(Landroid/view/View;Landroid/support/v4/g/a;)V

    const/4 v1, 0x0

    invoke-static {p0, v1}, Landroid/support/v4/g/cq;->a(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/u;

    invoke-interface {v1, p0}, Landroid/support/v4/widget/u;->a(Landroid/view/View;)V

    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/u;

    invoke-interface {v1, p1}, Landroid/support/v4/widget/u;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/g/bp;->b(Landroid/view/View;I)V
...
.method private static n(Landroid/view/View;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/g/bp;->b(Landroid/view/View;)I
...
.method a()Landroid/view/View;
    ...
    iget-boolean v0, v0, Landroid/support/v4/widget/y;->d:Z
...
.method public a(I)Ljava/lang/CharSequence;
    ...
    invoke-static {p1, v0}, Landroid/support/v4/g/q;->a(II)I
...
.method public a(II)V
    ...
    invoke-static {p2, v0}, Landroid/support/v4/g/q;->a(II)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bg;

    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/bg;->e()V
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bg;
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bg;->a()I

    move-result v2

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bg;

    invoke-virtual {v3}, Landroid/support/v4/widget/bg;->a()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->v:Landroid/support/v4/widget/x;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->v:Landroid/support/v4/widget/x;

    invoke-interface {v0, v1}, Landroid/support/v4/widget/x;->a(I)V
...
.method a(Z)V
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bg;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/bg;->a(Landroid/view/View;II)Z
    ...
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bg;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/bg;->a(Landroid/view/View;II)Z
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/aa;

    invoke-virtual {v0}, Landroid/support/v4/widget/aa;->a()V

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->n:Landroid/support/v4/widget/aa;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/g/bp;->b(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/support/v4/widget/t;

    invoke-static {p1, v0}, Landroid/support/v4/g/bp;->a(Landroid/view/View;Landroid/support/v4/g/a;)V
...
.method b(Landroid/view/View;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/widget/y;->d:Z

    if-eqz v1, :cond_1

    iput-boolean v2, v0, Landroid/support/v4/widget/y;->d:Z
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bg;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bg;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/bg;->a(Z)Z
    ...
    invoke-static {p0}, Landroid/support/v4/g/bp;->a(Landroid/view/View;)V
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bg;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/bg;->b()I
...
.method e(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/g/q;->a(II)I
...
.method g(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/g/bp;->d(Landroid/view/View;)I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v4/widget/y;-><init>(II)V
...
.method public h(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/bg;->a(Landroid/view/View;II)Z
...
.method public i(Landroid/view/View;)V
    ...
    iput-boolean v1, v0, Landroid/support/v4/widget/y;->d:Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/u;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->D:Ljava/lang/Object;

    invoke-interface {v0, v1}, Landroid/support/v4/widget/u;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Landroid/support/v4/widget/bg;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/bg;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/bg;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bg;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/bg;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bg;->d(I)Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {p2}, Landroid/support/v4/g/v;->a(Landroid/view/KeyEvent;)V
...
.method protected onMeasure(II)V
    ...
    iget v9, v0, Landroid/support/v4/widget/y;->a:I

    invoke-static {v9, v6}, Landroid/support/v4/g/q;->a(II)I

    move-result v9

    invoke-static {v8}, Landroid/support/v4/g/bp;->p(Landroid/view/View;)Z

    move-result v10

    if-eqz v10, :cond_a

    sget-object v10, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/u;

    iget-object v11, p0, Landroid/support/v4/widget/DrawerLayout;->D:Ljava/lang/Object;

    invoke-interface {v10, v8, v11, v9}, Landroid/support/v4/widget/u;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget v9, v0, Landroid/support/v4/widget/y;->leftMargin:I

    sub-int v9, v2, v9

    iget v10, v0, Landroid/support/v4/widget/y;->rightMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/y;->topMargin:I

    sub-int v10, v1, v10

    iget v0, v0, Landroid/support/v4/widget/y;->bottomMargin:I
    ...
    invoke-interface {v10, v0, v11, v9}, Landroid/support/v4/widget/u;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    invoke-static {v8}, Landroid/support/v4/g/bp;->m(Landroid/view/View;)F
    ...
    invoke-static {v8, v9}, Landroid/support/v4/g/bp;->d(Landroid/view/View;F)V
    ...
    iget v10, v0, Landroid/support/v4/widget/y;->leftMargin:I
    ...
    iget v10, v0, Landroid/support/v4/widget/y;->width:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/bg;->b(Landroid/view/MotionEvent;)V
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/bg;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/bg;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/bg;->d()I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/g/bp;->d(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroid/support/v4/widget/x;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->v:Landroid/support/v4/widget/x;
