...
.method static a(Landroid/widget/CompoundButton;)Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    sput-boolean v4, Landroid/support/v4/widget/k;->b:Z
    ...
    sput-object v1, Landroid/support/v4/widget/k;->a:Ljava/lang/reflect/Field;
...
.method static a(Landroid/widget/CompoundButton;Landroid/content/res/ColorStateList;)V
    ...
    instance-of v0, p0, Landroid/support/v4/widget/bf;

    if-eqz v0, :cond_0

    check-cast p0, Landroid/support/v4/widget/bf;

    invoke-interface {p0, p1}, Landroid/support/v4/widget/bf;->setSupportButtonTintList(Landroid/content/res/ColorStateList;)V
...
.method static a(Landroid/widget/CompoundButton;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/widget/bf;->setSupportButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
