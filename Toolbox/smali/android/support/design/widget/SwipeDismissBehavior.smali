...
# instance fields
.field private a:Landroid/support/v4/widget/bg;
...
.field private final j:Landroid/support/v4/widget/bj;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroid/support/design/widget/al;-><init>(Landroid/support/design/widget/SwipeDismissBehavior;)V

    iput-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/bj;
...
.method static synthetic a(Landroid/support/design/widget/SwipeDismissBehavior;)Landroid/support/design/widget/am;
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/design/widget/am;
...
.method private a(Landroid/view/ViewGroup;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->a:Landroid/support/v4/widget/bg;
    ...
    iget-object v1, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/bj;

    invoke-static {p1, v0, v1}, Landroid/support/v4/widget/bg;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bj;)Landroid/support/v4/widget/bg;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->a:Landroid/support/v4/widget/bg;

    :cond_0
    return-void

    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/bj;

    invoke-static {p1, v0}, Landroid/support/v4/widget/bg;->a(Landroid/view/ViewGroup;Landroid/support/v4/widget/bj;)Landroid/support/v4/widget/bg;
...
.method static synthetic b(Landroid/support/design/widget/SwipeDismissBehavior;)Landroid/support/v4/widget/bg;
    .locals 1
...
.method public a(Landroid/support/design/widget/am;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/design/widget/am;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p3}, Landroid/support/v4/widget/bg;->b(Landroid/view/MotionEvent;)V
...
.method public b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p3}, Landroid/support/v4/widget/bg;->a(Landroid/view/MotionEvent;)Z
