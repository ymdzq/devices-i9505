...
.field private e:Landroid/support/design/widget/ag;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/design/h;->SnackbarLayout:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Landroid/support/design/h;->SnackbarLayout_android_maxWidth:I
    ...
    sget v1, Landroid/support/design/h;->SnackbarLayout_maxActionInlineWidth:I
    ...
    sget v1, Landroid/support/design/h;->SnackbarLayout_elevation:I
    ...
    invoke-static {p0, v1}, Landroid/support/v4/g/bp;->d(Landroid/view/View;F)V
    ...
    sget v1, Landroid/support/design/f;->design_layout_snackbar_include:I
...
.method private static a(Landroid/view/View;II)V
    ...
    invoke-static {p0}, Landroid/support/v4/g/bp;->s(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Landroid/support/v4/g/bp;->g(Landroid/view/View;)I

    move-result v0

    invoke-static {p0}, Landroid/support/v4/g/bp;->h(Landroid/view/View;)I

    move-result v1

    invoke-static {p0, v0, p1, v1, p2}, Landroid/support/v4/g/bp;->a(Landroid/view/View;IIII)V
...
.method a(II)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/g/cy;->a(F)Landroid/support/v4/g/cy;
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/g/cy;->b(J)Landroid/support/v4/g/cy;
...
.method b(II)V
    ...
    invoke-static {v0, v4}, Landroid/support/v4/g/bp;->c(Landroid/view/View;F)V
...
.method protected onFinishInflate()V
    ...
    sget v0, Landroid/support/design/e;->snackbar_text:I
    ...
    sget v0, Landroid/support/design/e;->snackbar_action:I
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/ag;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/design/widget/ag;->a(Landroid/view/View;IIII)V
...
.method protected onMeasure(II)V
    ...
    sget v1, Landroid/support/design/d;->design_snackbar_padding_vertical_2lines:I
    ...
    sget v4, Landroid/support/design/d;->design_snackbar_padding_vertical:I
...
.method setOnLayoutChangeListener(Landroid/support/design/widget/ag;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/ag;
