...
# direct methods
.method constructor <init>(Landroid/widget/CompoundButton;Landroid/support/v7/internal/widget/am;)V
    .locals 2
    ...
    iput-object v1, p0, Landroid/support/v7/widget/u;->c:Landroid/content/res/ColorStateList;

    iput-object v1, p0, Landroid/support/v7/widget/u;->d:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v0, p0, Landroid/support/v7/widget/u;->e:Z

    iput-boolean v0, p0, Landroid/support/v7/widget/u;->f:Z

    iput-object p1, p0, Landroid/support/v7/widget/u;->a:Landroid/widget/CompoundButton;

    iput-object p2, p0, Landroid/support/v7/widget/u;->b:Landroid/support/v7/internal/widget/am;
...
.method a(I)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/u;->a:Landroid/widget/CompoundButton;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/u;->c:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/u;->c:Landroid/content/res/ColorStateList;
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/u;->d:Landroid/graphics/PorterDuff$Mode;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/u;->a:Landroid/widget/CompoundButton;

    iget-object v3, p0, Landroid/support/v7/widget/u;->b:Landroid/support/v7/internal/widget/am;

    invoke-virtual {v3, v0}, Landroid/support/v7/internal/widget/am;->a(I)Landroid/graphics/drawable/Drawable;
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/u;->d:Landroid/graphics/PorterDuff$Mode;
...
.method d()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/u;->c:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/u;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/u;->a:Landroid/widget/CompoundButton;
