...
.field private I:Landroid/support/v7/widget/bh;
...
.field private final N:Landroid/support/v7/internal/widget/am;
...
.field private final t:Landroid/support/v7/internal/widget/ac;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0}, Landroid/support/v7/internal/widget/ac;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/internal/widget/ac;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/be;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/bf;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-static {v0, p2, v1, p3, v7}, Landroid/support/v7/internal/widget/ao;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/internal/widget/ao;

    move-result-object v0

    sget v1, Landroid/support/v7/b/l;->Toolbar_titleTextAppearance:I

    invoke-virtual {v0, v1, v7}, Landroid/support/v7/internal/widget/ao;->g(II)I
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/internal/widget/ao;->c(II)I
    ...
    invoke-virtual {v0, v1, v7}, Landroid/support/v7/internal/widget/ao;->d(II)I
    ...
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/internal/widget/ao;->d(II)I
    ...
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/internal/widget/ao;->e(II)I
    ...
    invoke-virtual {v0, v1, v8}, Landroid/support/v7/internal/widget/ao;->d(II)I

    move-result v1

    sget v2, Landroid/support/v7/b/l;->Toolbar_contentInsetEnd:I

    invoke-virtual {v0, v2, v8}, Landroid/support/v7/internal/widget/ao;->d(II)I

    move-result v2

    sget v3, Landroid/support/v7/b/l;->Toolbar_contentInsetLeft:I

    invoke-virtual {v0, v3, v7}, Landroid/support/v7/internal/widget/ao;->e(II)I

    move-result v3

    sget v4, Landroid/support/v7/b/l;->Toolbar_contentInsetRight:I

    invoke-virtual {v0, v4, v7}, Landroid/support/v7/internal/widget/ao;->e(II)I

    move-result v4

    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/internal/widget/ac;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/internal/widget/ac;->b(II)V
    ...
    :cond_4
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/internal/widget/ac;

    invoke-virtual {v3, v1, v2}, Landroid/support/v7/internal/widget/ac;->a(II)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/ao;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/ao;->e(I)Z
    ...
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/internal/widget/ao;->b(II)I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->N:Landroid/support/v7/internal/widget/am;
...
.method private a(Landroid/view/View;I)I
    ...
    :goto_0
    iget v4, v0, Landroid/support/v7/widget/bi;->a:I
    ...
    iget v7, v0, Landroid/support/v7/widget/bi;->topMargin:I

    if-ge v1, v7, :cond_1

    iget v0, v0, Landroid/support/v7/widget/bi;->topMargin:I
    ...
    iget v5, v0, Landroid/support/v7/widget/bi;->bottomMargin:I
...
.method private a(Landroid/view/View;I[II)I
    ...
    iget v0, v0, Landroid/support/v7/widget/bi;->rightMargin:I
...
.method private a(Ljava/util/List;[I)I
    ...
    iget v8, v1, Landroid/support/v7/widget/bi;->leftMargin:I

    sub-int v6, v8, v6

    iget v1, v1, Landroid/support/v7/widget/bi;->rightMargin:I
...
.method static synthetic a(Landroid/support/v7/widget/Toolbar;)Landroid/support/v7/widget/bj;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->E:Landroid/support/v7/widget/bj;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/Toolbar;->i()Landroid/support/v7/widget/bi;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/bi;
...
.method private a(Ljava/util/List;I)V
    ...
    invoke-static {p2, v3}, Landroid/support/v4/g/q;->a(II)I
    ...
    iget v0, v0, Landroid/support/v7/widget/bi;->a:I
...
.method private b(I)I
    ...
    invoke-static {p1, v1}, Landroid/support/v4/g/q;->a(II)I
...
.method private b(Landroid/view/View;)I
    ...
    invoke-static {v0}, Landroid/support/v4/g/am;->a(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v1

    invoke-static {v0}, Landroid/support/v4/g/am;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private b(Landroid/view/View;I[II)I
    ...
    iget v1, v0, Landroid/support/v7/widget/bi;->rightMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/bi;->leftMargin:I
...
.method private m()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/bh;
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v7/widget/bh;-><init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/be;)V

    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/bh;
...
.method private p()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/bg;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
# virtual methods
.method public a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/bi;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v7/widget/bi;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method protected a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/bi;
    .locals 1
    ...
    check-cast p1, Landroid/support/v7/widget/bi;

    invoke-direct {v0, p1}, Landroid/support/v7/widget/bi;-><init>(Landroid/support/v7/widget/bi;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/bi;-><init>(Landroid/support/v7/a/b;)V
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/internal/widget/ac;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/internal/widget/ac;->a(II)V
...
.method public a(Landroid/support/v7/internal/view/menu/i;Landroid/support/v7/widget/ActionMenuPresenter;)V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/bh;

    if-nez v0, :cond_3

    new-instance v0, Landroid/support/v7/widget/bh;

    invoke-direct {v0, p0, v3}, Landroid/support/v7/widget/bh;-><init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/be;)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/bh;
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/bh;->a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/i;)V

    invoke-virtual {p2, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Z)V

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/bh;

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/bh;->a(Z)V
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/bi;
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/bi;
...
.method public getContentInsetEnd()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ac;->d()I
...
.method public getContentInsetLeft()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ac;->a()I
...
.method public getContentInsetRight()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ac;->b()I
...
.method public getContentInsetStart()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ac;->c()I
...
.method public getWrapper()Landroid/support/v7/internal/widget/w;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->G:Landroid/support/v7/internal/widget/ap;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/internal/widget/ap;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->G:Landroid/support/v7/internal/widget/ap;
...
.method protected i()Landroid/support/v7/widget/bi;
    .locals 2
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v7/widget/bi;-><init>(II)V
...
.method j()V
    ...
    iget v0, v0, Landroid/support/v7/widget/bi;->b:I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/g/bp;->k(Landroid/view/View;)I
    ...
    iget v9, v3, Landroid/support/v7/widget/bi;->topMargin:I
    ...
    iget v3, v3, Landroid/support/v7/widget/bi;->bottomMargin:I
    ...
    check-cast v4, Landroid/support/v7/widget/bi;
    ...
    iget v0, v3, Landroid/support/v7/widget/bi;->topMargin:I
    ...
    iget v3, v3, Landroid/support/v7/widget/bi;->topMargin:I
    ...
    iget v5, v3, Landroid/support/v7/widget/bi;->topMargin:I
    ...
    iget v4, v4, Landroid/support/v7/widget/bi;->bottomMargin:I
    ...
    iget v10, v3, Landroid/support/v7/widget/bi;->topMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1}, Landroid/support/v4/g/bp;->f(Landroid/view/View;)I

    move-result v1

    invoke-static {v9, v1}, Landroid/support/v7/internal/widget/au;->a(II)I
    ...
    invoke-static {v0}, Landroid/support/v4/g/bp;->f(Landroid/view/View;)I

    move-result v0

    invoke-static {v9, v0}, Landroid/support/v7/internal/widget/au;->a(II)I
    ...
    invoke-static {v11, v0}, Landroid/support/v7/internal/widget/au;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/g/bp;->f(Landroid/view/View;)I

    move-result v2

    invoke-static {v11, v2}, Landroid/support/v7/internal/widget/au;->a(II)I
    ...
    invoke-static {v1, p1, v2}, Landroid/support/v4/g/bp;->a(III)I
    ...
    invoke-static {v0, p2, v2}, Landroid/support/v4/g/bp;->a(III)I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-static {v0}, Landroid/support/v4/g/ar;->b(Landroid/view/MenuItem;)Z
...
.method public onRtlPropertiesChanged(I)V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/internal/widget/ac;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/internal/widget/ac;->a(Z)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/bh;->b:Landroid/support/v7/internal/view/menu/m;
...
.method public setLogo(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->N:Landroid/support/v7/internal/widget/am;
...
.method public setOnMenuItemClickListener(Landroid/support/v7/widget/bj;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->E:Landroid/support/v7/widget/bj;
