...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/ao;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/y;->setIndeterminateDrawable(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/ao;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-direct {p0, v1, v2}, Landroid/support/v7/widget/y;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/y;->setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    instance-of v0, p1, Landroid/support/v4/b/a/q;

    if-eqz v0, :cond_2

    move-object v0, p1

    check-cast v0, Landroid/support/v4/b/a/q;

    invoke-interface {v0}, Landroid/support/v4/b/a/q;->a()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/b/a/q;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/y;->b:Landroid/graphics/Bitmap;

    if-nez v1, :cond_7

    iput-object v0, p0, Landroid/support/v7/widget/y;->b:Landroid/graphics/Bitmap;

    :cond_7
    new-instance v1, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {p0}, Landroid/support/v7/widget/y;->getDrawableShape()Landroid/graphics/drawable/shapes/Shape;
...
.method protected declared-synchronized onMeasure(II)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->b:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/y;->getNumStars()I
    ...
    invoke-static {v0, p1, v1}, Landroid/support/v4/g/bp;->a(III)I
