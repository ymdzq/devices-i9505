...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    invoke-direct {p0, p1, v0, v1, v3}, Landroid/support/v4/widget/ar;-><init>(Landroid/content/Context;ILandroid/database/Cursor;Z)V

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v7/widget/bb;->p:Z

    iput v3, p0, Landroid/support/v7/widget/bb;->q:I

    iput v2, p0, Landroid/support/v7/widget/bb;->s:I

    iput v2, p0, Landroid/support/v7/widget/bb;->t:I

    iput v2, p0, Landroid/support/v7/widget/bb;->u:I

    iput v2, p0, Landroid/support/v7/widget/bb;->v:I

    iput v2, p0, Landroid/support/v7/widget/bb;->w:I

    iput v2, p0, Landroid/support/v7/widget/bb;->x:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bb;->j:Landroid/app/SearchManager;

    iput-object p2, p0, Landroid/support/v7/widget/bb;->k:Landroid/support/v7/widget/SearchView;

    iput-object p3, p0, Landroid/support/v7/widget/bb;->l:Landroid/app/SearchableInfo;

    invoke-virtual {p2}, Landroid/support/v7/widget/SearchView;->getSuggestionCommitIconResId()I

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/bb;->o:I

    iput-object p1, p0, Landroid/support/v7/widget/bb;->m:Landroid/content/Context;

    iput-object p4, p0, Landroid/support/v7/widget/bb;->n:Ljava/util/WeakHashMap;
...
.method private a(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bb;->n:Ljava/util/WeakHashMap;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/bb;->m:Landroid/content/Context;
    ...
    :cond_1
    invoke-direct {p0, p1}, Landroid/support/v7/widget/bb;->b(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    :goto_1
    iget-object v3, p0, Landroid/support/v7/widget/bb;->n:Ljava/util/WeakHashMap;
...
.method private a(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/bb;->m:Landroid/content/Context;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bb;->m:Landroid/content/Context;
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/bb;->b(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
...
.method private b(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_1
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bb;->a(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
    :try_end_1
...
.method private b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    sget v4, Landroid/support/v7/b/b;->textColorSearchUrl:I
...
.method private e(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/bb;->g(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
...
.method private f(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    iget v0, p0, Landroid/support/v7/widget/bb;->w:I
...
.method private g(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bb;->l:Landroid/app/SearchableInfo;
...
.method public a(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    :goto_0
    iget-object v2, p0, Landroid/support/v7/widget/bb;->k:Landroid/support/v7/widget/SearchView;
    ...
    :cond_2
    :try_start_0
    iget-object v2, p0, Landroid/support/v7/widget/bb;->l:Landroid/app/SearchableInfo;

    const/16 v3, 0x32

    invoke-virtual {p0, v2, v0, v3}, Landroid/support/v7/widget/bb;->a(Landroid/app/SearchableInfo;Ljava/lang/String;I)Landroid/database/Cursor;
...
.method public a(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-super {p0, p1, p2, p3}, Landroid/support/v4/widget/ar;->a(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v1

    new-instance v0, Landroid/support/v7/widget/bc;

    invoke-direct {v0, v1}, Landroid/support/v7/widget/bc;-><init>(Landroid/view/View;)V
    ...
    iget v2, p0, Landroid/support/v7/widget/bb;->o:I
...
.method public a(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/bb;->q:I
...
.method public a(Landroid/database/Cursor;)V
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/bb;->p:Z
    ...
    :cond_1
    :try_start_0
    invoke-super {p0, p1}, Landroid/support/v4/widget/ar;->a(Landroid/database/Cursor;)V
...
.method public a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    iget v1, p0, Landroid/support/v7/widget/bb;->x:I
    ...
    :goto_0
    iget-object v3, v0, Landroid/support/v7/widget/bc;->a:Landroid/widget/TextView;

    if-eqz v3, :cond_0

    iget v3, p0, Landroid/support/v7/widget/bb;->s:I

    invoke-static {p3, v3}, Landroid/support/v7/widget/bb;->a(Landroid/database/Cursor;I)Ljava/lang/String;

    move-result-object v3

    iget-object v4, v0, Landroid/support/v7/widget/bc;->a:Landroid/widget/TextView;

    invoke-direct {p0, v4, v3}, Landroid/support/v7/widget/bb;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    :cond_0
    iget-object v3, v0, Landroid/support/v7/widget/bc;->b:Landroid/widget/TextView;

    if-eqz v3, :cond_2

    iget v3, p0, Landroid/support/v7/widget/bb;->u:I
    ...
    invoke-direct {p0, v3}, Landroid/support/v7/widget/bb;->b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :cond_1
    :goto_2
    iget-object v4, v0, Landroid/support/v7/widget/bc;->b:Landroid/widget/TextView;

    invoke-direct {p0, v4, v3}, Landroid/support/v7/widget/bb;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    :cond_2
    iget-object v3, v0, Landroid/support/v7/widget/bc;->c:Landroid/widget/ImageView;

    if-eqz v3, :cond_3

    iget-object v3, v0, Landroid/support/v7/widget/bc;->c:Landroid/widget/ImageView;

    invoke-direct {p0, p3}, Landroid/support/v7/widget/bb;->e(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    const/4 v5, 0x4

    invoke-direct {p0, v3, v4, v5}, Landroid/support/v7/widget/bb;->a(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;I)V

    :cond_3
    iget-object v3, v0, Landroid/support/v7/widget/bc;->d:Landroid/widget/ImageView;

    if-eqz v3, :cond_4

    iget-object v3, v0, Landroid/support/v7/widget/bc;->d:Landroid/widget/ImageView;

    invoke-direct {p0, p3}, Landroid/support/v7/widget/bb;->f(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    invoke-direct {p0, v3, v4, v8}, Landroid/support/v7/widget/bb;->a(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;I)V

    :cond_4
    iget v3, p0, Landroid/support/v7/widget/bb;->q:I
    ...
    :cond_5
    iget-object v1, v0, Landroid/support/v7/widget/bc;->e:Landroid/widget/ImageView;

    invoke-virtual {v1, v2}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v1, v0, Landroid/support/v7/widget/bc;->e:Landroid/widget/ImageView;

    iget-object v2, v0, Landroid/support/v7/widget/bc;->a:Landroid/widget/TextView;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/bc;->e:Landroid/widget/ImageView;
    ...
    :cond_6
    iget v3, p0, Landroid/support/v7/widget/bb;->t:I
...
.method public c(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/bb;->l:Landroid/app/SearchableInfo;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :try_start_0
    invoke-super {p0, p1, p2, p3}, Landroid/support/v4/widget/ar;->getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v0, v0, Landroid/support/v7/widget/bc;->a:Landroid/widget/TextView;
...
.method public notifyDataSetChanged()V
    ...
    invoke-super {p0}, Landroid/support/v4/widget/ar;->notifyDataSetChanged()V

    invoke-virtual {p0}, Landroid/support/v7/widget/bb;->a()Landroid/database/Cursor;

    move-result-object v0

    invoke-direct {p0, v0}, Landroid/support/v7/widget/bb;->d(Landroid/database/Cursor;)V
...
.method public notifyDataSetInvalidated()V
    ...
    invoke-super {p0}, Landroid/support/v4/widget/ar;->notifyDataSetInvalidated()V
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bb;->k:Landroid/support/v7/widget/SearchView;
