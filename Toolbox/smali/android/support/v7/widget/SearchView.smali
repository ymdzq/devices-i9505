...
# static fields
.field static final a:Landroid/support/v7/widget/ax;
...
.field private q:Landroid/support/v7/widget/az;

.field private r:Landroid/support/v7/widget/ay;

.field private s:Landroid/view/View$OnFocusChangeListener;

.field private t:Landroid/support/v7/widget/ba;
...
.field private x:Landroid/support/v4/widget/m;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/ax;
...
.method private l()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->x:Landroid/support/v4/widget/m;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/widget/m;->a(Landroid/database/Cursor;)V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Landroid/support/v7/widget/bb;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->x:Landroid/support/v4/widget/m;

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object v2, p0, Landroid/support/v7/widget/SearchView;->x:Landroid/support/v4/widget/m;
    ...
    :cond_2
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bb;->a(I)V
...
.method private m()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/az;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/az;->a(Ljava/lang/String;)Z
...
.method private o()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/ay;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/ay;

    invoke-interface {v0}, Landroid/support/v7/widget/ay;->a()Z
...
.method private q()V
    ...
    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/ax;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ax;->a(Landroid/widget/AutoCompleteTextView;)V

    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/ax;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ax;->b(Landroid/widget/AutoCompleteTextView;)V
...
.method public clearFocus()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/ai;->clearFocus()V
...
.method public getSuggestionsAdapter()Landroid/support/v4/widget/m;
    .locals 1
...
.method public onWindowFocusChanged(Z)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/ai;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    :cond_3
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/ai;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Landroid/support/v7/widget/ay;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/ay;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/az;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/az;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/ba;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/support/v7/widget/ba;
...
.method public setSuggestionsAdapter(Landroid/support/v4/widget/m;)V
    .locals 2

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->x:Landroid/support/v4/widget/m;

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->x:Landroid/support/v4/widget/m;
