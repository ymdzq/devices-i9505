...
# interfaces
.implements Landroid/support/v4/widget/bf;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/internal/widget/am;

    new-instance v0, Landroid/support/v7/widget/u;

    iget-object v1, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/internal/widget/am;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/u;-><init>(Landroid/widget/CompoundButton;Landroid/support/v7/internal/widget/am;)V

    iput-object v0, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/u;
...
.method public getCompoundPaddingLeft()I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/u;
...
.method public getSupportButtonTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/u;->a()Landroid/content/res/ColorStateList;
...
.method public getSupportButtonTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/u;->b()Landroid/graphics/PorterDuff$Mode;
...
.method public setButtonDrawable(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/internal/widget/am;
    ...
    :goto_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/x;->setButtonDrawable(Landroid/graphics/drawable/Drawable;)V
