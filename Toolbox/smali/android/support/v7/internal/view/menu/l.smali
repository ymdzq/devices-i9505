...
.field private c:Landroid/support/v7/a/aa;
...
.method public a()V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/l;->c:Landroid/support/v7/a/aa;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/l;->c:Landroid/support/v7/a/aa;

    invoke-virtual {v0}, Landroid/support/v7/a/aa;->dismiss()V
...
.method public a(Landroid/os/IBinder;)V
    ...
    new-instance v1, Landroid/support/v7/a/ab;

    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/i;->e()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2}, Landroid/support/v7/a/ab;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroid/support/v7/internal/view/menu/g;

    invoke-virtual {v1}, Landroid/support/v7/a/ab;->a()Landroid/content/Context;

    move-result-object v3

    sget v4, Landroid/support/v7/b/i;->abc_list_menu_item_layout:I
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/a/ab;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/a/ab;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/a/ab;->a(Landroid/view/View;)Landroid/support/v7/a/ab;

    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/a/ab;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/a/ab;

    invoke-virtual {v1}, Landroid/support/v7/a/ab;->b()Landroid/support/v7/a/aa;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/view/menu/l;->c:Landroid/support/v7/a/aa;

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/l;->c:Landroid/support/v7/a/aa;

    invoke-virtual {v0, p0}, Landroid/support/v7/a/aa;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/l;->c:Landroid/support/v7/a/aa;

    invoke-virtual {v0}, Landroid/support/v7/a/aa;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/a/ab;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/a/ab;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/a/ab;->a(Ljava/lang/CharSequence;)Landroid/support/v7/a/ab;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/l;->c:Landroid/support/v7/a/aa;

    invoke-virtual {v1}, Landroid/support/v7/a/aa;->getWindow()Landroid/view/Window;
