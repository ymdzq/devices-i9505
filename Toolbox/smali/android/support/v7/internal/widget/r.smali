...
.method public a()I
    ...
    iput v1, p0, Landroid/support/v7/internal/widget/r;->c:I
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v7/internal/widget/r;->getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_0
    iput v4, p0, Landroid/support/v7/internal/widget/r;->c:I
...
.method public a(Landroid/support/v7/internal/widget/k;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/r;->d()Landroid/support/v7/internal/widget/k;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v1, p0, Landroid/support/v7/internal/widget/r;->a:Landroid/support/v7/internal/widget/ActivityChooserView;
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v7/internal/widget/r;->b:Landroid/support/v7/internal/widget/k;
...
.method public a(Z)V
    ...
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/r;->f:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, Landroid/support/v7/internal/widget/r;->f:Z
...
.method public a(ZZ)V
    ...
    :cond_0
    iput-boolean p1, p0, Landroid/support/v7/internal/widget/r;->d:Z

    iput-boolean p2, p0, Landroid/support/v7/internal/widget/r;->e:Z
...
.method public b()Landroid/content/pm/ResolveInfo;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/r;->b:Landroid/support/v7/internal/widget/k;
...
.method public d()Landroid/support/v7/internal/widget/k;
    .locals 1
...
.method public getCount()I
    ...
    iget-boolean v1, p0, Landroid/support/v7/internal/widget/r;->d:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/internal/widget/r;->b:Landroid/support/v7/internal/widget/k;
    ...
    iget-boolean v1, p0, Landroid/support/v7/internal/widget/r;->f:Z
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    sget v1, Landroid/support/v7/b/i;->abc_activity_chooser_view_list_item:I
    ...
    sget v2, Landroid/support/v7/b/j;->abc_activity_chooser_view_see_all:I
    ...
    sget v1, Landroid/support/v7/b/g;->list_item:I
    ...
    sget v0, Landroid/support/v7/b/g;->icon:I
    ...
    invoke-static {p2, v5}, Landroid/support/v4/g/bp;->c(Landroid/view/View;Z)V

    goto :goto_0

    :cond_4
    invoke-static {p2, v4}, Landroid/support/v4/g/bp;->c(Landroid/view/View;Z)V
