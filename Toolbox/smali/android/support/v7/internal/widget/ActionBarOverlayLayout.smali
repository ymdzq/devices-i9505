...
.field private final B:Landroid/support/v4/g/bg;
...
.field private f:Landroid/support/v7/internal/widget/w;
...
.field private w:Landroid/support/v4/widget/as;

.field private x:Landroid/support/v4/g/cy;

.field private final y:Landroid/support/v4/g/dp;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/g/dp;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/g/bg;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/g/bg;

    return-void
.end method

.method static synthetic a(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/g/cy;)Landroid/support/v4/g/cy;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/g/cy;

    return-object p1
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/internal/widget/w;
    .locals 3
...
.method private a(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Landroid/support/v4/widget/as;->a(Landroid/content/Context;)Landroid/support/v4/widget/as;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/as;
...
.method private a(FF)Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/as;
...
.method private a(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    iput v2, v0, Landroid/support/v7/internal/widget/j;->leftMargin:I
    ...
    iput v2, v0, Landroid/support/v7/internal/widget/j;->topMargin:I
    ...
    iput v2, v0, Landroid/support/v7/internal/widget/j;->rightMargin:I
    ...
    iput v2, v0, Landroid/support/v7/internal/widget/j;->bottomMargin:I
...
.method static synthetic b(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;)Landroid/support/v4/g/dp;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/g/dp;
...
.method private k()V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/g/cy;
...
# virtual methods
.method public a(Landroid/util/AttributeSet;)Landroid/support/v7/internal/widget/j;
    .locals 2
...
.method public a(I)V
    ...
    :sswitch_0
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/internal/widget/w;
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/w;->g()V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/internal/view/menu/y;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/internal/widget/w;->a(Landroid/view/Menu;Landroid/support/v7/internal/view/menu/y;)V
...
.method protected b()Landroid/support/v7/internal/widget/j;
    .locals 2
...
.method c()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/internal/widget/w;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/internal/widget/w;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/g/bp;->j(Landroid/view/View;)F
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/g/bp;->n(Landroid/view/View;)I
    ...
    invoke-static {p0, v1, v2}, Landroid/support/v7/internal/widget/au;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method protected synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->b()Landroid/support/v7/internal/widget/j;
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->a(Landroid/util/AttributeSet;)Landroid/support/v7/internal/widget/j;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/g/bg;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/w;->e()Ljava/lang/CharSequence;
...
.method public h()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/w;->l()Z
...
.method public j()V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/w;->n()V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/i;->j()V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    :goto_2
    invoke-interface {v5, v1}, Landroid/support/v7/internal/widget/i;->g(Z)V
...
.method protected onWindowVisibilityChanged(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/i;->b(I)V
...
.method public setActionBarVisibilityCallback(Landroid/support/v7/internal/widget/i;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/i;->b(I)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/w;->a(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/w;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/w;->b(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/w;->a(Landroid/view/Window$Callback;)V
