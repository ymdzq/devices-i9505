...
.field private final d:Landroid/support/v7/widget/ai;
...
.field private k:Landroid/support/v7/widget/ak;
...
.method private a(I)V
    ...
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/ak;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ak;->f(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/ak;->c()V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/g/n;
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/ak;->m()Landroid/widget/ListView;
    ...
    sget v2, Landroid/support/v7/b/j;->abc_activitychooserview_choose_application:I
...
.method private getListPopupWindow()Landroid/support/v7/widget/ak;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/ak;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/ak;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ak;->a(Landroid/view/View;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->d:Landroid/support/v7/widget/ai;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/ai;->layout(IIII)V
...
.method public setActivityChooserModel(Landroid/support/v7/internal/widget/k;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/r;->a(Landroid/support/v7/internal/widget/k;)V
...
.method public setProvider(Landroid/support/v4/g/n;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/g/n;
