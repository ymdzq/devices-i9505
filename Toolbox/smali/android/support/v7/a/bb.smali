.class public Landroid/support/v7/a/bb;
...
# instance fields
.field private a:Landroid/support/v7/a/ae;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p2}, Landroid/support/v7/a/bb;->a(Landroid/content/Context;I)I

    move-result v0

    invoke-direct {p0, p1, v0}, Landroid/app/Dialog;-><init>(Landroid/content/Context;I)V

    invoke-virtual {p0}, Landroid/support/v7/a/bb;->a()Landroid/support/v7/a/ae;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/support/v7/a/ae;->a(Landroid/os/Bundle;)V
...
# virtual methods
.method public a()Landroid/support/v7/a/ae;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/a/bb;->a:Landroid/support/v7/a/ae;

    if-nez v0, :cond_0

    invoke-static {p0, p0}, Landroid/support/v7/a/ae;->a(Landroid/app/Dialog;Landroid/support/v7/a/ad;)Landroid/support/v7/a/ae;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/a/bb;->a:Landroid/support/v7/a/ae;
...
.method public a(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/a/ae;->b(I)Z
...
.method public setTitle(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/a/bb;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/a/ae;->a(Ljava/lang/CharSequence;)V
